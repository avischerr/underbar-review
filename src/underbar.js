(function() {
  ...
  _.uniq = function(array, isSorted, iterator) {
    var result = [];
    var obj = {};
    var hasIterator = iterator !== undefined;
    ...
    return hasIterator ? Object.values(obj) : result;
  };
  ...
  _.every = function(collection, iterator) {
    ...
    _.each(collection, function (item) {
      if (iterator && !iterator(item) || !iterator && !item) {
        isTrue = false;
      }
    });
  ...
  _.some = function(collection, iterator) {
    ...
    _.each(collection, function (item) {
      if (iterator && iterator(item) || !iterator && item === true) {
        isTrue = true;
      }
    });
  ...
  _.memoize = function(func) {
    // set up cache
    var cache = {};
    var funcWithArgs = JSON.stringify(func.apply(this, arguments));
    // if present in cache,
    if (cache[funcWithArgs] !== undefined) {
      // return saved result
      return cache[funcWithArgs];
    } else {
    // else
      // add new property to cache
      var test = func.apply(this, arguments);
      cache[funcWithArgs] = func.call();
